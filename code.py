...
# Using lat/lon coordinates for precision - avoids ambiguous city name matches.
# Victor, Colorado: 38.7253, -105.1397
LAT = "38.7253"
LON = "-105.1397"

# Set up where we'll be fetching data from
DATA_SOURCE    = "http://api.openweathermap.org/data/2.5/weather?lat="+LAT+"&lon="+LON
DATA_SOURCE   += "&appid=" + getenv('openweather_token')
FORECAST_URL   = "http://api.openweathermap.org/data/2.5/forecast?lat="+LAT+"&lon="+LON
FORECAST_URL  += "&appid=" + getenv('openweather_token') + "&cnt=8"
